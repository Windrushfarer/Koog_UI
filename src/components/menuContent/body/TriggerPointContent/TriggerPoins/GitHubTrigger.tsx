        ...
        <div className="flex items-center justify-center gap-5 p-4">
          <div className="relative">
            ...
            <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-b from-neutral-900 to-neutral-800 shadow-md">
              <img src="/GitHub-logo.png" alt="GitHub logo" className="h-10 w-10 object-contain rounded-[20%]" />
            </div>
          </div>
          <div className="flex-1 text-left">
            <div className="text-lg sm:text-xl font-semibold text-neutral-100 tracking-tight">GitHub</div>
            <div className="text-sm text-neutral-300 mt-0.5">Trigger on new issues, PRs, or commits</div>
          </div>
          <span className={`inline-flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-b from-neutral-900 to-neutral-800 border border-neutral-700 text-neutral-400 transition ${isOpen ? 'text-slate-300 border-slate-400/40' : 'group-hover:text-slate-300 group-hover:border-slate-400/40'}`}>
            <svg
