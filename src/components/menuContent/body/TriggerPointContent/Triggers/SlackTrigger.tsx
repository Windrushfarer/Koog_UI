        ...
        <div className="flex items-center justify-center gap-5 p-4">
          ...
          <div className="flex-1 text-left">
            ...
            <div className="text-sm text-neutral-300 mt-0.5">
              Trigger on new messages, mentions, or channel activity
            </div>
          </div>
          <span
            className={`inline-flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-b from-neutral-900 to-neutral-800 border border-neutral-700 text-neutral-400 transition ${isOpen ? 'text-violet-300 border-violet-400/40' : 'group-hover:text-violet-300 group-hover:border-violet-400/40'}`}
          >
            <svg
