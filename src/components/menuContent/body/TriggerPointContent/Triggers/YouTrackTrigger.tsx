        ...
        <div className="flex items-center justify-center gap-5 p-4">
          ...
          <div className="flex-1 text-left">
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline-flex text-xs px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-300 border border-blue-500/30">
                Recommended
              </span>
            </div>
            <div className="text-sm text-neutral-300 mt-0.5">
              Trigger on new issues, updates, and comments
            </div>
          </div>
          <span
            className={`inline-flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-b from-neutral-900 to-neutral-800 border border-neutral-700 text-neutral-400 transition ${isOpen ? 'text-pink-300 border-pink-400/40' : 'group-hover:text-pink-300 group-hover:border-pink-400/40'}`}
          >
            <svg
